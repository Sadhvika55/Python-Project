...
pygame.mixer.init()
pygame.mixer.music.load("C:\\Users\\kokku\\OneDrive\\Desktop\\project\\fun-kids-playful-comic-carefree-game-happy-positive-music-57026.mp3")
...
def show_score(game_score: int):
    score_L['text'] = f"Guess left: {game_score}"
...
frame1 = Frame(master=display, pady=5, padx=20, bg="#fff8e9")
frame1.pack(expand=True)
Label(master=frame1, text="Clickomania", font=("helvertica",30), fg='blue', bg="white").pack()

frame2 = Frame(master=display, pady=5, padx=20, bg="pink")
frame2.pack(expand=True)

score_L = Label(master=frame2, text=f"Guess left: {score}", font=('calibre 25 bold',35), fg='#78a44e', bg="#fff8e9")
